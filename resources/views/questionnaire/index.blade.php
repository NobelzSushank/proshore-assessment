            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <div class="ms-auto">
                            <div>
                                <a href="{{route(Str::singular(Str::lower($pageTitle)) . '.create')}}" type="button" class="btn btn-primary btn-md">
    ...
    <script>
        $(document).ready(() => {
            $("#questionnaire-tables").DataTable({
                ...
                "scrollY": false,
                responsive: false,
                ajax: "{{route('questionnaire.index')}}",
                columns: [
        ...
        $('#questionnaire-tables').on('click', '#delete-btn', function (event) {
            event.preventDefault();
            event.stopPropagation();
            var id = $(this).data('id');
            var delete_url = "{{ route('questionnaire.destroy', '') }}/" + id;
